        ...
        <div class="container">
            ...
            <div class="masthead">
                ...
                <ul class="nav nav-justified">
                    <li><a href="Index.aspx">Научни Трудови</a></li>
                    <li class="active"><a href="Conference.aspx">Конференции</a></li>
                ...
                <ContentTemplate>
                    ...
                    <div class="main-content">
                        ...
                        <asp:Panel runat="server" ID="addConference" Style="display: block" class="add">
                            ...
                            <button type="button" class="close" aria-hidden="true" onclick="hide('addConference')">&times;</button>
                            <h3 class="text-muted">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="lblDateAbstract" runat="server" Text="Датум резиме"></asp:Label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="lblDateFullPaper" runat="server" Text="Датум цел труд"></asp:Label></td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="lblDateCameraRedy" runat="server" Text="Датум camera ready"></asp:Label></td>
                                    <td>
                        ...
                        <asp:Panel ID="pnlPopupInfo" runat="server" CssClass="modalPopup1" Style="display: none">
                            <div class="header">
                                ...
                                <button type="button" class="close" aria-hidden="true" onclick=" HideModalPopup1(); return hide('addConference')">&times;</button>
                            </div>
                            <div class="body">

                                <b>
                                    <asp:Label ID="Label1" runat="server" Text="Научен труд: "></asp:Label>
                                <asp:Label ID="lblSwTitle" runat="server" Text=""></asp:Label></b><br />
                                ...
                                <b>
                                    <asp:Label ID="Label14" runat="server" Text="Датум camera ready: "></asp:Label></b>
